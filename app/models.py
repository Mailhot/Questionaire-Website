...
from sqlalchemy import ForeignKey, Column, Integer, String, desc, event
...
@event.listens_for(QuizStyle.__table__, 'after_create')
def create_quizstyle(*args, **kwargs):
...
@event.listens_for(QuizContent.__table__, 'after_create')
...
def create_question(*args, **kwargs):
    ...
    db.session.add(Question(quiz_id=quiz1.id,question_number=2))
    db.session.add(Question(quiz_id=quiz1.id,question_number=3))
    db.session.add(Question(quiz_id=quiz1.id,question_number=4))
    db.session.add(Question(quiz_id=quiz1.id,question_number=5))
    db.session.add(Question(quiz_id=quiz1.id,question_number=6))
    db.session.add(Question(quiz_id=quiz1.id,question_number=7))
    db.session.add(Question(quiz_id=quiz1.id,question_number=8))
    db.session.add(Question(quiz_id=quiz1.id,question_number=9))
    db.session.add(Question(quiz_id=quiz1.id,question_number=10))

    db.session.add(Question(quiz_id=quiz2.id,question_number=1))
    db.session.add(Question(quiz_id=quiz2.id,question_number=2))
    db.session.add(Question(quiz_id=quiz2.id,question_number=3))
    db.session.add(Question(quiz_id=quiz2.id,question_number=4))
    db.session.add(Question(quiz_id=quiz2.id,question_number=5))
    db.session.add(Question(quiz_id=quiz2.id,question_number=6))
    db.session.add(Question(quiz_id=quiz2.id,question_number=7))
    db.session.add(Question(quiz_id=quiz2.id,question_number=8))
    db.session.add(Question(quiz_id=quiz2.id,question_number=9))
    db.session.add(Question(quiz_id=quiz2.id,question_number=10))
    db.session.commit()
...
@event.listens_for(QuestionContent.__table__, 'after_create')
def create_question_content(*args, **kwargs):
...
@event.listens_for(QuestionChoice.__table__, 'after_create')
def create_question_choice(*args, **kwargs):
